...
from ...modules.helpers import admin, admincount, block, clean_mode, command, reload, cbblock  # noqa


@Client.on_message(command(commands="atag") &~BANNED_CHATS &~BANNED_USERS)
@admin
@block
